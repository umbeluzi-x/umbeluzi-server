...
var file_provider_v1_provider_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xbc, 0x01, 0x0a, 0x0f, 0x50, 0x65, 0x74, 0x53, 0x74, 0x6f,
	0x72, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4f, 0x0a, 0x0a, 0x47, 0x65, 0x74,
...
var file_provider_v1_provider_proto_depIdxs = []int32{
	1, // 0: provider.v1.PetStoreService.GetPayment:input_type -> provider.v1.GetPaymentRequest
	0, // 1: provider.v1.PetStoreService.CreatePayment:input_type -> provider.v1.CreatePaymentRequest
	3, // 2: provider.v1.PetStoreService.GetPayment:output_type -> provider.v1.GetPaymentResponse
	2, // 3: provider.v1.PetStoreService.CreatePayment:output_type -> provider.v1.CreatePaymentResponse
